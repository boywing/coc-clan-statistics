...
$content .= '<th><a class="mywhite" href="?mode=search&search_string=' . $search_string . '&sort=name%20asc" title="Players name">Name</a></th>';
$content .= '<th><a class="mywhite" href="?mode=search&search_string=' . $search_string . '&sort=clan_name" title="Player is member of clan">Clan</a></th>';
$content .= '<th><a class="mywhite" href="?mode=search&search_string=' . $search_string . '&sort=role" title="Players role in the clan">Role</a></th>';
$content .= '<th><a class="mywhite" href="?mode=search&search_string=' . $search_string . '&sort=townHallLevel%20desc" title="Players Town Hall level">TH</a></th>';
$content .= '<th><a class="mywhite" href="?mode=search&search_string=' . $search_string . '&sort=expLevel%20desc" title="Players level">Lvl</a></th>';
$content .= '<th><a class="mywhite" href="?mode=search&search_string=' . $search_string . '&sort=trophies%20desc"><img height=25 src="images/Trophy.png"></a></th>';
$content .= '<th><a class="mywhite" href="?mode=search&search_string=' . $search_string . '&sort=warStars%20desc" title="Players collected stars in War">War stars</a</th>';
$content .= '<th><a class="mywhite" href="?mode=search&search_string=' . $search_string . '&sort=king%20desc"><img height=25 src="images/Barbarian King.png"></a></th>';
$content .= '<th><a class="mywhite" href="?mode=search&search_string=' . $search_string . '&sort=queen%20desc"><img height=25 src="images/Archer Queen.png"></a></th>';
$content .= '<th><a class="mywhite" href="?mode=search&search_string=' . $search_string . '&sort=warden%20desc"><img height=25 src="images/Grand Warden.png"></a></th>';
$content .= '<th><a class="mywhite" href="?mode=search&search_string=' . $search_string . '&sort=stars%20desc" title="Average stars from all attacks during the last '. $days . ' days">Avg stars</a></th>';
$content .= '<th><a class="mywhite" href="?mode=search&search_string=' . $search_string . '&sort=mirr_stars%20desc" title="Average stars from mirror attacks during the last '. $days . ' days">Avg mirror stars</a></th>';
$content .= '<th><a class="mywhite" href="?mode=search&search_string=' . $search_string . '&sort=th_stars%20desc" title="Average stars agains the same TH level during the last '. $days . ' days">Avg TH stars</a></th>';
$content .= '<th><a class="mywhite" href="?mode=search&search_string=' . $search_string . '&sort=mirr_stars%20desc" title="Average stars from mirror attacks during the last '. $days . ' days">Avg mirror stars</a></th>';
$content .= '<th><a class="mywhite" href="?mode=search&search_string=' . $search_string . '&sort=th_stars%20desc" title="Average stars agains the same TH level during the last '. $days . ' days">Avg TH stars</a></th>';
$content .= '<th><a class="mywhite" href="?mode=search&search_string=' . $search_string . '&sort=def_stars%20desc" title="Average stars the opponent made to own base during the last '. $days . ' days">Def stars</a></th>';
$content .= '<th><a class="mywhite" href="?mode=search&search_string=' . $search_string . '&sort=three_stars%20desc" title="Total amount of attacks resulting in three stars during the last '. $days . ' days">3-stars</a></th>';
$content .= '<th><a class="mywhite" href="?mode=search&search_string=' . $search_string . '&sort=attacks%20desc" title="Total amount of attacks played">Attacks</a></th>';
$content .= '<th><a class="mywhite" href="?mode=search&search_string=' . $search_string . '&sort=createDate" title="When players first appeared in our database">First seen</a></th>';
$content .= '<th><a class="mywhite" href="?mode=search&search_string=' . $search_string . '&sort=last_war%20desc">Last War</a></th>';
$content .= '<th><a class="mywhite" href="?mode=search&search_string=' . $search_string . '&sort=donations%20desc">Donations</a></th>';
$content .= '<th><a class="mywhite" href="?mode=search&search_string=' . $search_string . '&sort=donations%20desc" title="Donations ratio donated/recieved during the season">Ratio</a></th></thead>';
$content .= "<tbody>";
