...
(select round(avg(attack_stars),1) from attacks where attacker_tag = p.tag AND attacker_th = defender_th AND attacker_map_pos = defender_map_pos AND startTime >= date_sub(now(), interval $days day)) as stars, 
